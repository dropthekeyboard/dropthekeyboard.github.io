    ...
    >
      ...
      <div className="flex-1 flex items-center justify-end space-x-1">
        ...
        <div className="flex items-center">
          <Signal className={cn('w-4 h-4 text-black dark:text-white')} />
        </div>

        {/* Battery */}
        <div className="flex items-center">
          <Battery className={cn('w-4 h-4 text-black dark:text-white')} />
          <span
            className={cn(
              'text-xs ml-0.5 font-medium text-black dark:text-white'
            )}
          >
            {100}%
          </span>
