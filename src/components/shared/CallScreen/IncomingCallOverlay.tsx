...
export function IncomingCallOverlay({
  ...
  // callerEntity에서 display name 추출
  const displayName = callerEntity?.displayName || callerEntity?.name || 'Service Provider';
  const isRinging = true; // PhoneSection에서 조건부 렌더링하므로 항상 true
