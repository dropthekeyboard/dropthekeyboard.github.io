  ...
  return (
    <div className="w-full h-full bg-background text-foreground flex flex-col items-center justify-center text-center p-10 relative">
        ...
        <div className="relative z-10">
            <h2 className="text-3xl font-bold text-muted-foreground mb-8">들어가며</h2>
            <p className="text-6xl font-bold">
                AI는 <span className="text-primary">A</span>gent <span className="text-primary">t</span>o <span className="text-primary">A</span>nything
            </p>
