      ...
      <div className="bg-card p-8 rounded-lg w-full max-w-4xl flex flex-col items-center">
        ...
        <div className="flex items-center mb-8">
          ...
          <div className="bg-primary text-primary-foreground p-4 rounded-lg relative">
            <p className="text-lg">지금도 전화로 충분한데 굳이 복잡한 절차를 해야 하나?</p>
        ...
        <div className="flex items-center">
          ...
          <div className="flex space-x-4">
            <div className="bg-secondary text-secondary-foreground p-4 rounded-lg text-lg">앱설치</div>
            <div className="bg-secondary text-secondary-foreground p-4 rounded-lg text-lg">메뉴 등록</div>
            <div className="bg-secondary text-secondary-foreground p-4 rounded-lg text-lg">예약 시스템</div>
          </div>
        </div>
