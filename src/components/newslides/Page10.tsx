  ...
  const messages1: Message[] = [
    {
      from: 'SK텔레콤 AI Agent',
      to: 'user',
      content: '이번주 화요일 7시에 5명 양식당 예약해줘',
      timestamp: 1,
      senderType: 'customer',
      type: 'text',
    },
  ...
  const messages2: Message[] = [
    {
      ...
      to: 'user',
      content:
        '사장님, 오후 3시 30분에 예약 문의가 와서요. 임시로 예약 잡아드렸는데, 혹시 못 받으시면 알려주세요.',
      timestamp: 1,
      senderType: 'agent',
      type: 'text',
    },
    ...
    <div className="w-full h-full bg-background text-foreground flex flex-col items-center justify-center p-10">
      <div className="text-center mb-10">
        ...
        <p className="text-xl mt-4 max-w-3xl text-muted-foreground">
          착신실패시 문자 자동전환되는 Failover는 Task성공률을 높일 수 있는
          전국망을 보유한 통신사만의 차별적 역량
        </p>
      </div>
