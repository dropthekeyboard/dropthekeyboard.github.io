      ...
      <div className="max-w-4xl w-full space-y-10">
        ...
        <header className="text-center space-y-3">
          <h1 className="text-3xl sm:text-4xl font-bold text-white tracking-tight">
            <span className="text-gray-300">초기 A2A를</span>{' '}
            <span className="text-white">앱 기반으로 시작할 경우</span>
            <span className="block text-lg font-normal text-gray-400 mt-2">
              전화번호만으로 예약을 관리해온 영세 소상공인은
            </span>
          </h1>
          <p className="text-md sm:text-lg text-gray-400">
            앱 설치, 메뉴 등록, 예약 시스템 세팅 등{' '}
            <span className="text-white font-bold">초기 진입 장벽</span>에 막혀
            온보딩이 지연될 가능성이 큼
          </p>
        </header>
