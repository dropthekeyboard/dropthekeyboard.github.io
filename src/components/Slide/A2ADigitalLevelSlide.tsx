      ...
      <div className="max-w-4xl w-full space-y-10">
        ...
        <header className="text-center space-y-3">
          <h1 className="text-3xl sm:text-4xl font-bold text-white tracking-tight">
            하지만, 소상공인의 경우{' '}
            <span className="text-[#A23AFF]">디지털화 수준이 낮아</span>
          </h1>
          <p className="text-md sm:text-lg text-gray-400">
            곧바로 Agent ↔ Agent 모델로 전환하기에는{' '}
            <strong className="text-white">현실적 제약</strong>이 큼
          </p>
        </header>
            ...
            <div className="flex flex-row items-end justify-center gap-16 py-12">
              ...
              <div className="flex flex-col items-center">
                <div className="relative flex flex-col items-center">
                  {/* 실제 값 바 (파란색-보라색) */}
                  <div
                    className="w-16 bg-gradient-to-r from-[#3A8BFF] to-[#A23AFF] rounded-t-lg absolute bottom-0"
                    style={{ height: '40px' }}
                  />
                  {/* 배경 바 (회색) */}
                  <div
                    className="w-16 bg-gradient-to-b from-gray-300 to-gray-700 rounded-lg"
                    style={{ height: '160px' }}
                  />
                  <span className="absolute -top-12 left-1/2 -translate-x-1/2 text-3xl font-bold text-white">
                    11.7%
                  </span>
                </div>
