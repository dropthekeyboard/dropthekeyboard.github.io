...
export default function GSAPSlidesPage() {
  return (
    <div>
      ...
      <SlideGSAPSection pin pinDistance={1600} scrub={1} className="min-h-screen bg-neutral-900 flex items-center justify-center" variant="scaleIn" ease="back.out(1.7)">
        <div data-anim>
          <Slide001 />
        </div>
      </SlideGSAPSection>
